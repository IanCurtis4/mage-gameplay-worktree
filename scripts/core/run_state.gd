...
const CLASS_ID: StringName = &"swordsman"
...
func get_modifiers() -> Dictionary:
	...
	return {"flat": flat, "increased": increased}
...
func _create_augment(augment_id: StringName, display_name: String, description: String, effect_id: StringName, magnitude: float) -> AugmentDefinition:
